const forum_categories = [
    ...
    {category: 'Off Topic', description: 'Discuss and share your thoughts outside of trails and hiking.'}
]

document.addEventListener('DOMContentLoaded', () => {
    document.getElementById('ic-users').innerHTML = sizeIcon('users',56);
    document.getElementById('discussion').innerHTML = sizeIcon('discussion',28);
